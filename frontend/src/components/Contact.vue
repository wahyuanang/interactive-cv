...
<template>
  <footer id="kontak" class="py-20 bg-gray-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <a
        href="mailto:linarahmati30@gmail.com"
      ...
      <div class="flex justify-center space-x-6 mb-8">
        <a
          href="https://github.com/linarahmawti"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/lina-rahmati-254972260/"
          target="_blank"
          class="text-gray-400 hover:text-white transition-colors duration- 300"
          >LinkedIn</a
        >
      ...
      <p class="text-gray-500">
        &copy; {{ new Date().getFullYear() }} Lina Rahmawati. Dibuat dengan sepenuh hati
      </p>
    </div>
  </footer>
</template>
